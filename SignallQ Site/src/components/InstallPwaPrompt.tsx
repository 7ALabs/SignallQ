...
// CTA de instalação discreto — pill fixo no canto, não compete visualmente
// com o DownloadAppCallout (esse continua sendo a promoção principal do app
// Android nativo). Em Android/Chrome/Edge/desktop, o clique já dispara o
// prompt nativo do navegador; em iOS Safari (sem essa API) abre um dialog
// leve com a instrução manual, no mesmo padrão visual do ConfirmDialog.
export function InstallPwaPrompt() {
  ...
  return (
    <>
      <div
        className="sq-fade-up fixed bottom-4 left-4 z-[900] flex items-center gap-1.5 rounded-full border py-2 pl-3.5 pr-2"
