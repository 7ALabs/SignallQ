...
## Passos
1. Verificar se há task `IN_PROGRESS` para o agente em `.Codex/tasks/active/`.
2. Se ocupado → retornar "Agente ocupado. Finalizar TASK-XXX primeiro."
3. Se livre → listar `.Codex/tasks/queue/<agente>/` ordenado por data de criação.
4. Pegar a mais antiga (primeira da fila).
5. Mover para `.Codex/tasks/active/`.
...
Task file: .Codex/tasks/active/TASK-XXX.md
