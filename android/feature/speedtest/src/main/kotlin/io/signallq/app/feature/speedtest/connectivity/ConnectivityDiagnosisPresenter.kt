...
object ConnectivityDiagnosisPresenter {
    fun apresentar(diagnostico: ConnectivityDiagnosis): ConnectivityDiagnosisMensagem =
        when (diagnostico.status) {
            ...
            ConnectivityStatus.NO_LOCAL_ADDRESS ->
                ConnectivityDiagnosisMensagem(
                    ...
                    mensagem =
                        "Seu celular está conectado ao Wi-Fi, mas não recebeu um endereço de rede " +
            ...
            ConnectivityStatus.GATEWAY_UNREACHABLE ->
                ConnectivityDiagnosisMensagem(
                    ...
                    mensagem =
                        when (diagnostico.confidence) {
                            NivelConfianca.ALTA ->
                                "Confirmamos: seu celular está conectado ao Wi-Fi, mas não " +
                                    "consegue se comunicar com o roteador."
                            NivelConfianca.MEDIA ->
                                "Há sinais de que seu celular está conectado ao Wi-Fi, mas " +
                                    "não consegue se comunicar com o roteador."
                            NivelConfianca.BAIXA ->
                                "O problema parece estar entre o celular e o roteador, mas " +
            ...
            ConnectivityStatus.DNS_FAILURE ->
                ConnectivityDiagnosisMensagem(
                    ...
                    mensagem =
                        when (diagnostico.confidence) {
                            NivelConfianca.ALTA ->
                                "O teste mostrou que a conexão está ativa, mas o serviço que " +
                                    "localiza os sites não está respondendo."
                            NivelConfianca.MEDIA, NivelConfianca.BAIXA ->
                                "A conexão parece estar ativa, mas há " +
            ...
            ConnectivityStatus.EXTERNAL_ROUTE_FAILURE ->
                ConnectivityDiagnosisMensagem(
                    ...
                    mensagem =
                        when (diagnostico.confidence) {
                            NivelConfianca.ALTA ->
                                "Confirmamos: o sinal chega até o roteador e o DNS responde, " +
                                    "mas esta rede não está conseguindo alcançar a internet além disso."
                            NivelConfianca.MEDIA, NivelConfianca.BAIXA ->
                                "A causa mais provável é que o sinal " +
            ...
            ConnectivityStatus.PARTIAL_CONNECTIVITY ->
                ConnectivityDiagnosisMensagem(
                    ...
                    mensagem =
                        "Há sinais de instabilidade nesta rede: parte das conexões funciona e parte " +
     ...
     */
    fun apresentarInconclusivo(): ConnectivityDiagnosisMensagem =
        ConnectivityDiagnosisMensagem(
            titulo = "Diagnóstico inconclusivo",
            mensagem =
                "Confirmamos que esta rede está sem acesso normal à internet, mas não foi " +
