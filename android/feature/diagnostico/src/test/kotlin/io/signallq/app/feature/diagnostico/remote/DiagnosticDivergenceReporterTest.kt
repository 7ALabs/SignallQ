...
class DiagnosticDivergenceReporterTest {
    ...
    private fun flagProvider(enabled: Boolean): FeatureFlagProvider =
    ...
    private fun sampleComparison() =
        DiagnosticDivergenceClassifier.Comparison(
    ...
    @Test
    fun `isEligibleForShadowComparison falso quando o kill switch esta desligado, mesmo com rollout 100 por cento`() =
        runTest {
    ...
    @Test
    fun `isEligibleForShadowComparison falso quando o status de rollout nao esta disponivel (fail closed)`() =
        runTest {
    ...
    @Test
    fun `isEligibleForShadowComparison falso com rolloutPercent 0`() =
        runTest {
    ...
    @Test
    fun `isEligibleForShadowComparison verdadeiro com kill switch ligado, rollout 100 por cento e instalacao valida`() =
        runTest {
    ...
    @Test
    fun `isEligibleForShadowComparison respeita segmentacao por canal`() =
        runTest {
            val rep =
                reporterComRollout(
    ...
    @Test
    fun `isEligibleForShadowComparison respeita segmentacao por versao minima`() =
        runTest {
            val rep =
                reporterComRollout(
    ...
    @Test
    fun `report nao envia nada quando a flag esta desligada`() =
        runTest {
    ...
    @Test
    fun `report nao envia nada sem consentimento LGPD`() =
        runTest {
    ...
    @Test
    fun `report envia payload sanitizado quando habilitado e com consentimento`() =
        runTest {
    ...
    @Test
    fun `report nunca lanca excecao quando o worker esta indisponivel`() =
        runTest {
    ...
    @Test
    fun `report omite campos nulos opcionais (remoteStatus, remoteScore, remoteSource)`() =
        runTest {
