...
object WifiSignalQualityEngine {
    fun avaliar(input: WifiDiagnosticInput?): WifiQualityResult {
        ...
        if (wifiStandardStr != null) {
            val stdResultado =
                when {
                    wifiStandardStr.contains("Wi-Fi 4") ->
                        DiagnosticResult(
                            id = "WIFI-STD-04",
                    ...
                    wifiStandardStr.contains("Wi-Fi 5") ->
                        DiagnosticResult(
                            id = "WIFI-STD-05",
                    ...
                    wifiStandardStr.contains("Wi-Fi 6") || wifiStandardStr.contains("Wi-Fi 7") ->
                        DiagnosticResult(
                            id = "WIFI-STD-6X",
