...
class ChatSessionDaoTest {
    ...
    @Test
    fun apagarSessao_mensagensCascateiam() =
        runTest {
            dao.salvarSessao(sessao())
    ...
    @Test
    fun renomearSessao_atualizaTituloETimestamp() =
        runTest {
    ...
    @Test
    fun observarSessoes_ordenadoPorAtualizadoEmDesc() =
        runTest {
    ...
    @Test
    fun observarMensagens_ordenadoPorCreatedAtAsc() =
        runTest {
            dao.salvarSessao(sessao())
    ...
    @Test
    fun contarSessoes_retornaNumeroCorreto() =
        runTest {
    ...
    @Test
    fun atualizarMensagem_persisteAlteracoes() =
        runTest {
            dao.salvarSessao(sessao())
