    ...
    Column(
        ...
        ObjetivoDiagnostico.entries.forEach { objetivo ->
            AssistObjectiveRow(
                ...
                subtitle = objetivo.subtitulo,
                icon = objetivo.iconeAssist(),
...
private fun AssistObjectiveRow(
    ...
    SignallQListRow(title = title, subtitle = subtitle, icon = icon, onClick = onClick)
}

private fun ObjetivoDiagnostico.iconeAssist(): ImageVector =
    when (this) {
        ObjetivoDiagnostico.INTERNET_CAI_OSCILA -> Icons.Outlined.SignalCellularAlt
        ObjetivoDiagnostico.VIDEOS_TRAVAM,
        ObjetivoDiagnostico.CHAMADAS_CONGELAM,
        ...
        ObjetivoDiagnostico.WIFI_VS_OPERADORA -> Icons.Outlined.Wifi
    }
