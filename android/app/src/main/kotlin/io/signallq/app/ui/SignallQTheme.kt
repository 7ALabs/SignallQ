...
object LkColors {
    ...
    object Light {
        ...
        val surfaceDim = Color(0xFFDEDEE1)
        val surfaceContainerLowest = Color(0xFFFFFFFF)
        val surfaceContainerLow = Color(0xFFF7F7F8)
        val surfaceContainer = Color(0xFFF1F1F2)
        val surfaceContainerHigh = Color(0xFFE8E8EA)
        val surfaceContainerHighest = Color(0xFFDEDEE1)
        val onSurface = Color(0xFF1C1C1F)
        val onSurfaceVariant = Color(0xFF48484D)
        val outline = Color(0xFF73737A)
        val outlineVariant = Color(0xFFC8C8CD)
