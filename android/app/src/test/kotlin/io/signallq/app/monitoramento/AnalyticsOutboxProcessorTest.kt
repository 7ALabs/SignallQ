...
class AnalyticsOutboxProcessorTest {
    ...
    @Test
    fun `acknowledgement valido remove evento e registra enviado e aceito`() =
        runBlocking {
    ...
    @Test
    fun `acknowledgement ausente ou incorreto mantem evento e aplica backoff`() =
        runBlocking {
    ...
    @Test
    fun `revogacao de consentimento limpa fila sem enviar`() =
        runBlocking {
    ...
    @Test
    fun `payload corrompido e perdido sem tentar rede`() =
        runBlocking {
