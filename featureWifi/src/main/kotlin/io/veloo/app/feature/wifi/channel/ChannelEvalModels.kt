...
// Uma rede vizinha já normalizada — sem dependência de android.*
data class Neighbor(
    val bssid: String,
    val band: Band,
    val centerFreqMhz: Int,   // centro do segmento principal (centerFreq0 do ScanResult)
    val centerFreq1Mhz: Int?, // segundo segmento apenas para 80+80; null caso contrário
...
data class ChannelScore(
    ...
    val score: Double,        // interferência acumulada em mW; MENOR = melhor
