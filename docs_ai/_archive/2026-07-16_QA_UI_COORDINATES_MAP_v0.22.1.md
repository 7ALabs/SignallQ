> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: coordenadas de toque pre-MD3, tela redesenhada; sem substituto formal, referencia historica. Preservado apenas como referencia historica -- nao reflete o estado atual.
