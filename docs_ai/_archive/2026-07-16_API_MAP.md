> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: TECNICO.md secao 7 e docs_ai/CONTRATOS/openapi/. Preservado apenas como referencia historica -- nao reflete o estado atual.
