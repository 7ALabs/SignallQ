> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: DESIGN_SYSTEM.md secoes 4-5 (Espacamento, Raios). Preservado apenas como referencia historica -- nao reflete o estado atual.
