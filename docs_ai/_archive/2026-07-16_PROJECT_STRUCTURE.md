> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: TECNICO.md e docs_ai/ARQUITETURA/README.md -- descrevia raiz pre-monorepo, desatualizado. Preservado apenas como referencia historica -- nao reflete o estado atual.
