> **Arquivado em 2026-07-23.** Duplicava quase integralmente
> `docs_ai/operations/APK_OUTPUT_POLICY.md` (mesma política de nome/pasta/comando, exemplo
> desatualizado com `versionName 0.16.0`). Conteúdo consolidado em `APK_OUTPUT_POLICY.md`,
> que é o documento ativo — atualizar lá, não aqui.
