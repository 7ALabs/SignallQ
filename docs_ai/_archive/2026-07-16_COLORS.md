> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: DESIGN_SYSTEM.md secao 2 (Cores). Preservado apenas como referencia historica -- nao reflete o estado atual.
