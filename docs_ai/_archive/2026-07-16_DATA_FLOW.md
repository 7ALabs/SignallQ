> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: TECNICO.md secao 8.4 (Uso conjunto) e ARQUITETURA/README.md secao 3 (Fluxo de dados). Preservado apenas como referencia historica -- nao reflete o estado atual.
