> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: FUNCIONAL.md secoes 2 e 3 (Navegacao, Telas e bottom sheets). Preservado apenas como referencia historica -- nao reflete o estado atual.
