> **Arquivado em 2026-07-16.** Consolidacao de documentacao docs_ai/ (branch docs/consolidacao-documentacao-docs-ai). Conteudo absorvido por: docs_ai/ARQUITETURA/README.md -- reflete v0.16.0/0.18.1, autodeclarado historico. Preservado apenas como referencia historica -- nao reflete o estado atual.
