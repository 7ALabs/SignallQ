...
class MonitoramentoWorkerHistereseTest {
    ...
    @Test
    fun `latencia oscilando abaixo de 400ms nao gera transicao`() = runTest {
    ...
    @Test
    fun `latencia cruza 400ms dispara alerta uma vez e oscilacoes mantem estado`() = runTest {
        // 350 → 450 → 380 → 420 → 280
    ...
    @Test
    fun `latencia null mantem estado anterior sem transicao (Doze Mode)`() = runTest {
    ...
    @Test
    fun `latencia null com estado ok mantem ok`() = runTest {
    ...
    @Test
    fun `latencia na zona de histerese mantem estado anterior`() = runTest {
    ...
    @Test
    fun `dns cruza 2500ms dispara alerta e oscilacoes mantem estado`() = runTest {
    ...
    @Test
    fun `dns null mantem estado anterior`() = runTest {
    ...
    @Test
    fun `dns na zona de histerese entre 1800 e 2500 mantem estado`() = runTest {
    ...
    @Test
    fun `rssi cruza -75 dispara alerta e sai quando passa de -68`() = runTest {
        // -60 → -78 → -72 → -76 → -65
        var estado = false
    ...
    @Test
    fun `rssi null mantem estado anterior`() = runTest {
    ...
    @Test
    fun `rssi na zona de histerese entre -75 e -68 mantem estado`() = runTest {
    ...
    @Test
    fun `sem latencia e sem dns com semWifi ativa alerta sem internet`() = runTest {
    ...
    @Test
    fun `latencia volta ativa resolve alerta sem internet`() = runTest {
    ...
    @Test
    fun `dns volta resolve alerta sem internet`() = runTest {
    ...
    @Test
    fun `sem latencia e sem dns mas semWifi false mantem estado anterior`() = runTest {
    ...
    @Test
    fun `sem internet nao dispara quando rssi motivo e Invalido`() = runTest {
    ...
    @Test
    fun `sem internet nao dispara quando rssi motivo e SemPermissao`() = runTest {
