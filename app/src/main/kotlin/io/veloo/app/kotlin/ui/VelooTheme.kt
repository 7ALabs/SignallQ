...
object LkColors {
    ...
    val velooBlack = Color(0xFF0D0D1A)
    val velooDarkSurface = Color(0xFF1A0B2E)
    val velooDarkCard = Color(0xFF1E1130)
    val velooTextOnDark = Color(0xFFF3F4F6)
    val velooTextSecondaryOnDark = Color(0xFF9CA3AF)
...
fun VelooTheme(
    ...
    CompositionLocalProvider(LocalLkTokens provides tokens) {
        MaterialTheme(
            ...
            typography = velooTypography,
            content = content,
        )
    }
}

// Escala tipográfica Veloo — Material 3 / WCAG 2.2 AA.
