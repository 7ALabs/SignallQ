...
Skill de geração e atualização de documentação. Conduzida por **Caio** (revisão independente) e **Claudete** (produto/portfólio) conforme o tipo de documento — ver ADR-014.
