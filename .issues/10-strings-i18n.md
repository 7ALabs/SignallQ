## Contexto
Strings de UI estão hardcoded em Composables, impedindo internacionalização e dificultando revisão de copy. Ex.: cards de sugestão do Orbit têm labels fixos no Kotlin. O design system já é consistente; falta apenas externalizar texto.

## Evidência
- `app/src/main/kotlin/io/linka/app/kotlin/ui/component/OrbitWelcomeState.kt:46-61` — "Internet lenta", "Streaming ruim", etc.
