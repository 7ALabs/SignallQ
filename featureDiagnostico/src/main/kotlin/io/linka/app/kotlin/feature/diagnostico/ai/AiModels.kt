...
import io.linka.app.kotlin.feature.diagnostico.DiagnosticReport
import io.linka.app.kotlin.feature.diagnostico.DiagnosticStatus
import io.linka.app.kotlin.feature.diagnostico.HistoricalDiagnosticInput
import io.linka.app.kotlin.feature.diagnostico.InternetDiagnosticInput
import io.linka.app.kotlin.feature.diagnostico.SpeedtestQualityInput
...
data class ModeloIa(
    ...
    val nomeExibicao: String = "Linka IA",
    val nomeCompletoComercial: String = "Linka IA",
    val descricaoComercial: String = "",
    val textoRodape: String = "Motor de análise: Linka IA",
) {
    companion object {
        ...
        fun localFallback(): ModeloIa = ModeloIa(
            ...
            nomeCompletoComercial = "Diagnóstico local do Linka",
            descricaoComercial = "Análise feita pelo próprio app, sem IA externa.",
            textoRodape = "Motor de análise: Diagnóstico local do Linka",
        )
    }
}
...
object AiFallbackFactory {
    fun fromLocal(report: DiagnosticReport): AiDiagnosisResult {
        ...
        val mensagem = report.decisao.mensagemUsuario.ifBlank { "Diagnóstico concluído pelo Linka." }
