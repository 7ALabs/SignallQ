...
Ver [ADR-014](../../../docs_ai/decisions/ADR-014-squad-canonico-ai-governance.md) + [`ai-governance/agents/`](../../../../ai-governance/agents/). Agentes válidos para SignallQ (`--de` / `--para`):

`claudete` · `camilo` · `juliana` · `marcos` · `gustavo` · `caio` · `luiz`
