---
description: Centraliza thresholds de diagnóstico de rede, padrões técnicos brasileiros (ANATEL), topologia doméstica (CGNAT, duplo-NAT), Wi-Fi, Fibra e redes móveis (4G/5G). Substitui o agente Bernardo. Consultar antes de implementar qualquer engine de diagnóstico.
---
...
- Implementação → Camilo (Android) ou Renan (PWA).
